...
birthday = datetime.datetime(2004, 1, 4)
tbirthday = datetime.datetime(1980, 3, 31)
...
# 7. 내 생일이 며칠 남았는지?
sm_birthday = datetime.datetime(2021, 9, 23)
print(sm_birthday - now)
yj_birthday = datetime.datetime(2021, 1, 4)
if yj_birthday < now:
    yj_birthday = yj_birthday.replace(year=yj_birthday.year + 1)
    # yj_birthday.year = yj_birthday.year + 1     #not writable
print(yj_birthday - now)
